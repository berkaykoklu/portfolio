...
export const UI = {
  en: {
    ...
    hero: {
      roleA: "AI Engineer",
      roleB: "ML Engineer",
      lede: "Building production AI systems, and researching how agents learn from generated worlds.",
      viewWork: "View work",
      facts: [
        ...
        { k: "OPEN SOURCE", v: "4 live systems", sub: "deployed, measured, documented" },
      ],
    },
    pipeline: { label: "PRODUCTION PATH" },
    sections: {
      ...
      research: { title: "Where I'm going next", lead: "M.Sc. thesis direction, and the chain of work leading into it. Early research — there are no results here yet." },
  ...
  tr: {
    ...
    hero: {
      ...
      facts: [
        ...
        { k: "YÜKSEK LİSANS", v: "Boğaziçi", sub: "Elektrik-Elektronik Mühendisliği" },
        { k: "AÇIK KAYNAK", v: "4 canlı sistem", sub: "yayında, ölçülmüş, belgelenmiş" },
      ],
    },
